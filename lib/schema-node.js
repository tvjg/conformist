...
class SchemaNode {
  ...
  combine (childFns) {
    ...
    return this.validators.concat(propertyValidators, notValidators, anyOfValidators, allOfValidators)
  }
  ...
  get children () {
    let properties, not, anyOf, allOf
    ...
    return [].concat(properties, not, anyOf, allOf)
  }
